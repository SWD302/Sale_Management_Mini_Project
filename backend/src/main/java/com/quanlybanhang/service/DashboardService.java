...
public class DashboardService {
  ...
  private enum DashboardPeriod {
    ...
    MONTH_1("month_1", "Tháng 1", "Tháng 12 trước"),
    MONTH_2("month_2", "Tháng 2", "Tháng 1"),
    MONTH_3("month_3", "Tháng 3", "Tháng 2"),
    MONTH_4("month_4", "Tháng 4", "Tháng 3"),
    MONTH_5("month_5", "Tháng 5", "Tháng 4"),
    MONTH_6("month_6", "Tháng 6", "Tháng 5"),
    MONTH_7("month_7", "Tháng 7", "Tháng 6"),
    MONTH_8("month_8", "Tháng 8", "Tháng 7"),
    MONTH_9("month_9", "Tháng 9", "Tháng 8"),
    MONTH_10("month_10", "Tháng 10", "Tháng 9"),
    MONTH_11("month_11", "Tháng 11", "Tháng 10"),
    MONTH_12("month_12", "Tháng 12", "Tháng 11");
    ...
    /** Trả về số tháng cụ thể nếu là MONTH_N, null nếu không phải. */
    ...
    private static DashboardPeriod fromQuery(String raw) {
      ...
      return switch (raw.trim().toLowerCase()) {
        ...
        case "month_3"  -> MONTH_3;
        case "month_4"  -> MONTH_4;
        case "month_5"  -> MONTH_5;
        case "month_6"  -> MONTH_6;
        case "month_7"  -> MONTH_7;
        case "month_8"  -> MONTH_8;
        case "month_9"  -> MONTH_9;
        case "month_10" -> MONTH_10;
        case "month_11" -> MONTH_11;
        case "month_12" -> MONTH_12;
        default         -> MONTH;
      };
    }
    ...
    private LocalDateTime periodStart(LocalDateTime now) {
      ...
      Integer m = specificMonth();
      if (m != null) {
        // Tính năm: nếu tháng đó đã qua trong năm này thì dùng năm hiện tại, ngược lại là năm trước
        int year = day.getYear();
        return LocalDate.of(year, m, 1).atStartOfDay();
      }
      return switch (this) {
        ...
        default -> day.withDayOfMonth(1).atStartOfDay();
      };
    }

    private LocalDateTime nextPeriodStart(LocalDateTime periodStart) {
      Integer m = specificMonth();
      if (m != null) return periodStart.plusMonths(1);
      return switch (this) {
